-- 1. Receita por canal com participação percentual
SELECT
...
-- 2. Ranking de estados por faturamento
SELECT
    e.sigla AS estado,
...
-- 3. Ticket médio por estado comparado à média geral
SELECT
    e.sigla AS estado,
...
-- 4. Evolução mensal com crescimento em relação ao mês anterior
SELECT
